-- Pustakata import untuk Hostinger/phpMyAdmin.
-- Pilih database Hostinger terlebih dahulu, lalu import file ini.
-- File ini sengaja tidak memakai CREATE DATABASE atau USE agar cocok dengan
-- nama database Hostinger yang biasanya memiliki prefix akun.
